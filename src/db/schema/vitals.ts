import { pgTable, timestamp, varchar, smallint, decimal, bigint, serial, index, uuid } from 'drizzle-orm/pg-core';
...
export const vitals = pgTable('vitals', {
    ...
    return {
        ...
        orgIdx: index('vitals_org_id_idx').on(table.orgId, table.deletedAt),
    }
}).enableRLS();
