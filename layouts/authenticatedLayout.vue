<template>
    <div class="flex h-screen bg-gray-300 px-2 dark:bg-slate-800">
            ...
            <div class="overflow-hidden p-2 mt-5">
                <div class="mb-10">
                    ...
                    <template v-if="!isCollapsed">
                        ...
                        <div class="text-center text-gray-800 font-medium italic">
                            Doctor
                        </div>
                    </template>
                </div>
                ...
                <NuxtLink to="/testing">
                    <div @click="setCurrentTab('dashboard')" class="flex items-center space-x-4 rounded-full  mb-3 hover:outline hover:outline-2 hover:outline-blue-300" :class="currentTab === 'dashboard' ? 'bg-sky-300 text-zinc-50' : 'bg-gray-200'">
                        <!-- SVG Icon -->
                ...
                <NuxtLink to="/patients">
                    <div @click="setCurrentTab('patients')" class="flex items-center space-x-4 rounded-full mb-3 hover:outline hover:outline-2 hover:outline-blue-300" :class="currentTab === 'patients' ? 'bg-sky-300 text-zinc-50' : 'bg-gray-200'">
                        <!-- SVG Icon -->
                ...
                <div @click="setCurrentTab('queue')" class="flex items-center space-x-4 rounded-full  mb-3 hover:outline hover:outline-2 hover:outline-blue-300" :class="currentTab === 'queue' ? 'bg-sky-300 text-zinc-50' : 'bg-gray-200'">
                    <!-- SVG Icon -->
                ...
                <NuxtLink to="schedule">
                    <div @click="setCurrentTab('schedule')" class="flex items-center space-x-4 rounded-full mb-3 hover:outline hover:outline-2 hover:outline-blue-300" :class="currentTab === 'schedule' ? 'bg-sky-300 text-zinc-50' : 'bg-gray-200'">
                        <!-- SVG Icon -->
                ...
                <div @click="setCurrentTab('profile')" class="flex items-center space-x-4 rounded-full  mb-3 hover:outline hover:outline-2 hover:outline-blue-300" :class="currentTab === 'profile' ? 'bg-sky-300 text-zinc-50' : 'bg-gray-200'">
                    <!-- SVG Icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-12 h-12 flex-shrink-0 ml-1" :class="{ 'ml-4': !isCollapsed }">
                ...
                <div @click="setCurrentTab('logout'); logout();" class="flex items-center space-x-4 rounded-full mb-3 hover:outline hover:outline-2 hover:outline-blue-300" :class="currentTab === 'logout' ? 'bg-sky-300 text-zinc-50' : 'bg-gray-200'">
                    <!-- SVG Icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-10 h-10 flex-shrink-0 ml-1" :class="{ 'ml-4': !isCollapsed }">
        ...
        <!-- Main Content -->
        <div class="flex-1 p-6 overflow-auto rounded-xl bg-zinc-100 ml-2 mt-2 mb-2">
            <slot></slot>
        </div>
    </div>
</template>
